...
namespace GluwaAPI.TestEngine.Utils
{
    ...
    {
        // Web3 URLs
        private const string URL = "http://baas-rpc.luniverse.io:8545?lChainId=1635501961136826136";
        private const string URL_MAINNET = "http://baas-rpc.luniverse.io:8545?lChainId=3158073271666164067";
        private const string URL_ETH = "https://goerli.infura.io/v3/34f5075b588b482ca887e2cbc851e6c6";
        private const string URL_ETH_MAINNET = "https://mainnet.infura.io/v3/34f5075b588b482ca887e2cbc851e6c6";
        private const string URL_INFURA_RPC = "https://goerli.infura.io/v3/6f3e0a3bf0334d7691df2da0c06863aa";
        private const string URL_INFURA_RPC_MAINNET = "https://mainnet.infura.io/v3/a2590f66af7f4a188a67250dacbf591e";
        private const string URL_BINANCE_RPC = "https://data-seed-prebsc-1-s1.binance.org:8545";
        private const string URL_LUNIVERSE_RPC = "https://baas-rpc.luniverse.io:18545";

        // Contract Addresses
        private const string BURN_FROM_ADDRESS = "0x928ef75709ea7e8d112ed63b5c041dd9493f8448";
        private const string BURN_FROM_ADDRESS_MAINNET = "0x4dfdf0f1d41af6c3ccbb8b0eccaee690c00f12ef";
        private const string FTA_ADDRESS = "0x2f6033bD9bF8F15e3fEdAaf0Efe6F3584aEaEC69";
        private const string FTA_ADDRESS_MAINNET = "0xe23bCe06837F70584475957c7B6fbb6b0C8735Ac";
        ...
        public static string GetFtaApproveSignature(AddressItem addressSource, string amount, string environment, ECurrency currency = ECurrency.Usdc)
        {
            ...
            else if (currency.Equals(ECurrency.Usdc) && (environment.Equals("Staging") || (environment.Equals("Production"))))
            {
                ...
                ftaContract = "0x8bd4be20d07d76d7eeef79a349727702b5f671f7";
            ...
            {
                web3 = new Web3(currencyInfo.nodeUrl);
                ftaContract = "0x3979BF2767A97dFf24823138494Ad690a18f112F";
                gas = new HexBigInteger(FTA_GAS_LIMIT);
                gasPrice = new HexBigInteger(GetSafeGasPrice());
            ...
            {
                web3 = new Web3(currencyInfo.nodeUrl);
                ftaContract = "BSCMainnetFTAContract";
                gas = new HexBigInteger(FTA_GAS_LIMIT);
                gasPrice = new HexBigInteger(GetSafeGasPrice());
                approverAccount = new Account(addressSource.PrivateKey, currencyInfo.chainId);
            }
        ...
        private static Function getFunction(string functionName, ECurrency currency = ECurrency.Usdc, string environment = "Test")
        {
            ...
            if ((currency == ECurrency.Usdc) && (environment == "Test") && (functionName.Equals("approve")))
            {
                ...
                contract = web3.Eth.GetContract(Shared.APPROVE_ABI, "0x07865c6e87b9f70255377e024ace6630c1eaa37f");
            }
            ...
            else if ((currency == ECurrency.Usdc) && (environment == "Staging"))
            {
                ...
                contract = web3.Eth.GetContract(Shared.FTA_ABI, "0xe23bCe06837F70584475957c7B6fbb6b0C8735Ac");
            }
            else if ((currency == ECurrency.Usdc) && (environment == "Production"))
            {
                web3 = new Web3(URL_ETH_MAINNET);
                contract = web3.Eth.GetContract(Shared.FTA_ABI, "0x8bd4be20d07d76d7eeef79a349727702b5f671f7");
            }
        ...
        private static Function getFunction(string functionName, CurrencyItem currencyInfo, ECurrency currency = ECurrency.Usdc, string environment = "Test")
        {
            ...
            {
                web3 = new Web3(currencyInfo.nodeUrl);
                contract = web3.Eth.GetContract(Shared.FTA_ABI, "0x3979BF2767A97dFf24823138494Ad690a18f112F");
            }
            else if ((currency == ECurrency.Usdc) && (environment == "Staging"))
            {
                web3 = new Web3(URL_ETH_MAINNET);
        ...
        {
            var containerClient = new BlobContainerClient(new Uri("https://devgluwaabistore.blob.core.windows.net/gluwaabis"), new DefaultAzureCredential());
            var path = name;
