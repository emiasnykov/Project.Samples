...
describe("Tests for listing transaction history for an address.", function () {
    ...
    describe("Positive Test cases without limit.", function () {
        ...
        it("Get_AddressTransactions_USDG_Pos", function() {
            return Gluwa.getTrasactionHistory(currency,optionals)
                .then((result) => {
        ...
        it("Get_AddressTransactions_KRWG_Pos", function() {
            return Gluwa.getTrasactionHistory(currency,optionals)
                .then((result) => {
                    assertion.handleAssertionStatusCode(result, testname, 200);
                }).catch((error) => {
    ...
    describe("Positive Test cases with limit.", function () {
        ...
        it("Get_AddressTransactions_USDG_Limit1_Pos", function() {
            optionals.Limit = "1";
            return Gluwa.getTrasactionHistory(currency,optionals)
                .then((result) => {
                    assertion.handleAssertionStatusCode(result, testname, 200);
        ...
        it("Get_AddressTransactions_USDG_Limit99_Pos", function() {
            optionals.Limit = "99";
            return Gluwa.getTrasactionHistory(currency,optionals)
                .then((result) => {
                    assertion.handleAssertionStatusCode(result, testname, 200);
        ...
        it("Get_AddressTransactions_USDG_Limit101_Pos", function() {
            optionals.Limit = "101";
            return Gluwa.getTrasactionHistory(currency,optionals)
                .then((result) => {
        ...
        it("Get_AddressTransactions_USDG_DecimalLimit_Pos", function() {
            optionals.Limit = "1.1";
            return Gluwa.getTrasactionHistory(currency,optionals)
                .then((result) => {
