...
const currencyList = ["USDG", "sUSDCG", "KRWG", "sKRWCG", "NGNG", "sNGNG", "BTC"];
...
async function getTrasactionHistory(currency, optionals) {
    setEnvironment(isSandbox);
...
module.exports = { isSandbox, getBalance, createTransaction, createQRCode, 
    getTrasactionHistory, getTransactionDetail, getWebhookValidation, getCurrencyFromTestName, getAmount }