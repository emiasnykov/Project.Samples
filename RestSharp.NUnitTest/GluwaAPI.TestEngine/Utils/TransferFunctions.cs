...
namespace GluwaAPI.TestEngine.Utils
{
    ...
    public class TransferFunctions
    {
        ...
        public static string NotFoundTxnHash(string environment)
        {
            ...
            {
                case "Test":
                    return "a214ee064f2fa5ed8f940c4501fabe54c50a9531a44e86f0c1347d4ebf72d5cf";
                case "Staging":
        ...
        public static string GetSasSignature(string currency)
        {
            ...
            {
                case "Usd":
                    return "ContractABI.txt?sp=r&st=2022-01-04T19:41:18Z&se=2022-12-31T03:41:18Z&spr=https&sv=2020-08-04&sr=b&sig=NWbX8eVCZ0i6%2Br8qlLKxdaVa%2FA1DfX3SBbaG12JzEsc%3D";
                case "Usdc":
                    return "ContractABI.txt?sp=r&st=2022-01-04T20:42:52Z&se=2022-12-31T04:42:52Z&spr=https&sv=2020-08-04&sr=b&sig=%2FAt5get%2BUq3w87SiTYUni43vAF7EUgZ0pG81LzjrwnE%3D";
                case "GTD":
                    return "ContractABI.txt?sp=r&st=2022-07-12T15:45:29Z&se=2023-01-01T00:45:29Z&spr=https&sv=2021-06-08&sr=b&sig=EETUZw6zZBemt9t%2F%2FjrYX1qdOuciDqaWB2s0J5cJSSA%3D";
                case "GATE":
                    return "ContractABI.txt?sp=r&st=2022-07-12T15:48:05Z&se=2023-01-01T00:48:05Z&spr=https&sv=2021-06-08&sr=b&sig=uPwWVDXuKQZtLWHReshnpql%2BmIseCgYfyrAm1gCusQE%3D";
                case "Gcre":
                    return "ContractABI.txt?sp=r&st=2022-07-12T15:46:55Z&se=2023-01-01T00:46:55Z&spr=https&sv=2021-06-08&sr=b&sig=v%2Bw7k1Mrevk30BEVsUCEZVerazLvLaUA0%2BrYXAy7E0M%3D";
                default:
        ...
        {
            string abiUrl = "https://devgluwaabistore.blob.core.windows.net/gluwaabis/";
            ...
            Assertions.HandleSetupAssertions(200, response);
            NUnit.Framework.Assert.IsFalse(string.IsNullOrEmpty(response.Content), "Response didn't return contract abi");
        ...
        public string Get_AccountBalance(string environment, string type)
        {
            ...
            if (type == "Bond")
            {
                endpoint = "v1/BondAccount/AvailableBalance";
            }
            else
            {
                endpoint = "v1/PrizeLinked/AvailableBalance";
            }
        ...
        public static ContractAddressItem GetContractAddress(string environment, string currency)
        {
            ...
            {
                url = "https://api-test.gluwa.com/";
                endpoint = $"v1/Contract/Address/{currency}/Testnet";
            }

            else
            {
                url = "https://api.gluwa.com/";
